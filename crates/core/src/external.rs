...
/// [`discover_and_measure`], plus the store interiors. What
/// `report::observe_scope` calls; `discover_and_measure` is the same
/// pass with the interiors dropped, for callers that only want units.
#[allow(clippy::too_many_arguments)]
