...
//! ported: 2026-09-23, to the spent-by-value confirmation (re-review 5, finding 2); earlier 2026-09-22, to the confirmed-approval API (`approve_confirmed` + `HumanConfirmed`); the shape -- the reviewed call extracted into a helper beside `cmd_approve` -- is the reviewer's
