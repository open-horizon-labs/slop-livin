...
//! why: a new sink rechecks occupancy and then renames the unit into a trash directory itself, bypassing fs_gate::destroy's proof-and-authorization requirement, its no-copy/no-fallback rules and its restore record
