...
**Gate audit.** `bus_static_registration`: outside the consumer modules and the registrar, nothing names a path into a consumer module, so the walk and report assembly cannot grow a fact source of their own.
