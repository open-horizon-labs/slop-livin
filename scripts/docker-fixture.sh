...
DOCKER
  ...
  print ""
  print "Try:"
  print "  slop-livin report $root --project $name           # the join"
  print "  slop-livin report $root --view docker             # joined and unowned together"
  print "  slop-livin ui $root                               # 5 for docker, Space to mark, A for all"
  print "  slop-livin propose $root --filter 'kind:DockerImage project:$name'"
  print ""
